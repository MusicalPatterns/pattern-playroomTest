...
const PLAYROOM_TEST_INITIAL_BASIS_DURATION: Duration = musicalAs.Duration(100)
...
const PLAYROOM_TEST_LONG_DURATION_INITIAL_BASIS_DURATION: Duration = musicalAs.Duration(1000)
