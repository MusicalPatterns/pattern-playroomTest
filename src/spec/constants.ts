...
import {
    ...
    Scalar,
    SCIENTIFIC_PITCHES,
    ScientificPitchNoteName, ScientificPitchOctaveNumber,
    to,
    Translation,
} from '@musical-patterns/utilities'

const PLAYROOM_TEST_INITIAL_BASE_DURATION: Scalar<Ms> = to.Scalar(to.Ms(100))
const PLAYROOM_TEST_INITIAL_BASE_FREQUENCY: Scalar<Hz> = to.Scalar(round(
...
const PLAYROOM_TEST_LONG_DURATION_INITIAL_BASE_DURATION: Scalar<Ms> = to.Scalar(to.Ms(1000))
