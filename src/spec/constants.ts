...
const PLAYROOM_TEST_INITIAL_BASIS_DURATION: Duration = as.Translation<Point<Ms>>(100)
const PLAYROOM_TEST_INITIAL_BASIS_FREQUENCY: Point<Hz> = round(
...
const PLAYROOM_TEST_LONG_DURATION_INITIAL_BASIS_DURATION: Duration = as.Translation<Point<Ms>>(1000)
